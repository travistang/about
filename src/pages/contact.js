				...
				<div container>
					<Scroll.Element name="contact">
								...
								<Fade>
									<div style={style.contact.container.method}>
										...
										<div style={style.contact.container.method.detail}>
											{method.url ? (
												<a href={method.fullURL || method.url}>
													{method.detail}
												</a>
											) : (
												method.detail
						...
						<div style={style.contact.container.copyright}>
							Copyright <FontAwesomeIcon icon={faCopyright} /> 2018 -{" "}
							{new Date().getFullYear()} Tang Yiu Ting. All rights reserved.
							<a href="https://www.iubenda.com/privacy-policy/77487588">
								{" "}
								Privacy Policy{" "}
							</a>
						</div>
